...
const Portfolio = ({ isDarkMode }: PortfolioProps) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Advanced voice-based assistant using NLP and OpenAI API, with a scope of integration with Arduino for smart home control",
      image: "https://images.unsplash.com/photo-1589254065878-42c9da997008?auto=format&fit=crop&q=80",
      tags: ["Python", "NLP", "OpenAI API", "Arduino", "NLTK","React"],
      githubLink: "https://github.com/hemu77/JAR--007/tree/main"
    }
  ];
